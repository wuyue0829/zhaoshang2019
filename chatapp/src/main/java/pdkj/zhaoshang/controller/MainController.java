...
import pdkj.zhaoshang.activity.AddProjectActivity;
import pdkj.zhaoshang.activity.MainActivity;
import pdkj.zhaoshang.activity.fragment.ContactsFragment;
import pdkj.zhaoshang.activity.fragment.ConversationListFragment;
import pdkj.zhaoshang.activity.fragment.MeFragment;
import pdkj.zhaoshang.activity.fragment.ProjectFragment;
import pdkj.zhaoshang.activity.fragment.SettingFragment;
...
public class MainController implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.actionbar_project_btn:
