...
import pdkj.zhaoshang.controller.SendFileController;
...
public class SendFileActivity extends FragmentActivity {
    ...
    private RelativeLayout send_file_rl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_file_rl = findViewById(R.id.send_file_rl);
        if(!BaseUtil.isSpace(getIntent().getExtras().getString("node"))){
            send_file_rl.setVisibility(View.GONE);
        }
