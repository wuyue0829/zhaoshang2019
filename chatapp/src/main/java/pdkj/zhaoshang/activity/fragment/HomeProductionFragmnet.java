...
public class HomeProductionFragmnet extends Fragment{
    ...
    public HomeProductionFragmnet(MyViewPage vp, int fragmentID,List<ResultProjectData.ProjectData> list){
        this.vp = vp;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRootView = layoutInflater.inflate(R.layout.test_main2,
