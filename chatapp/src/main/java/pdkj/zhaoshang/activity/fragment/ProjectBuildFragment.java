...
public class ProjectBuildFragment extends BaseFragment{
    ...
    private VerticalStepView setpview1;
    ...
    public ProjectBuildFragment(Context mContext,List<ResultDetailListData.NodeList> list,String projectID,String projectName,String num){
        this.list1 = list;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView= inflater.inflate(R.layout.project_content1,null);
        return mView;
    }
    ...
    private void initView(){
        ...
        setpview1 = mView.findViewById(R.id.step_view1);
    ...
    private void initData(){
        ...
        if(!BaseUtil.isSpace(list1)){
            ...
            for(int i = 0; i<list1.size();i++){
                list0.add(list1.get(i).getTitle());
            }
            ...
            x.http().post(params, new Callback.CommonCallback<String>() {
                ...
                public void onSuccess(String result) {
                    ...
                    setpview1.setStepsViewIndicatorComplectingPosition(c)//设置完成的步数
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("stageId",list1.get(0).getStageId());
