...
import pdkj.zhaoshang.utils.citychoose.view.SelectAddressDialog;
import pdkj.zhaoshang.utils.citychoose.view.myinterface.SelectAddressInterface;
import pdkj.zhaoshang.utils.photochoose.ChoosePhoto;
import pdkj.zhaoshang.utils.photochoose.PhotoUtils;
...
public class PersonalActivity extends BaseActivity implements SelectAddressInterface, View.OnClickListener {
    ...
    private void initData() {
        ...
        if (mMyInfo != null) {
            ...
            if(BaseUtil.isSpace(mMyInfo.getAddress())){
                mTv_city.setText(SharePreferenceManager.getAddress());
            }else{
